...
Version  : 0.2.11
Release  : 38
URL      : https://cran.r-project.org/src/contrib/clustMixType_0.2-11.tar.gz
Source0  : https://cran.r-project.org/src/contrib/clustMixType_0.2-11.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615390629
